...
\subsection{Math}
\subsubsection{Training parameters and hidden layers}
Before handling inputs, we will first change training parameters' values and hidden layer structures. 
...
We will keep the school input for our Math network, as it increases our accuracy.
